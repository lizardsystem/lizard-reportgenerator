...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportTemplate.doc_support'
        db.add_column('lizard_reportgenerator_reporttemplate', 'doc_support', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportTemplate.doc_support'
        db.delete_column('lizard_reportgenerator_reporttemplate', 'doc_support')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 26, 11, 21, 57, 87267)'}),
        ...
        'lizard_reportgenerator.generatedreport': {
            ...
            'data_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_security.DataSet']", 'null': 'True', 'blank': 'True'}),
            'generated_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 11, 21, 57, 413433)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
