...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_reportgenerator_reporttemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('kind', self.gf('django.db.models.fields.CharField')(default='algemeen', max_length=255)),
        ))
        db.send_create_signal('lizard_reportgenerator', ['ReportTemplate'])

        # Adding model 'GeneratedReport'
        db.create_table('lizard_reportgenerator_generatedreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document_rtf', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('document_pdf', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_reportgenerator.ReportTemplate'])),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_area.Area'])),
            ('generated_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal('lizard_reportgenerator', ['GeneratedReport'])


    def backwards(self, orm):
        
        # Deleting model 'ReportTemplate'
        db.delete_table('lizard_reportgenerator_reporttemplate')

        # Deleting model 'GeneratedReport'
        db.delete_table('lizard_reportgenerator_generatedreport')
