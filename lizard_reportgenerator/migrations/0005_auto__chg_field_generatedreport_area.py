...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeneratedReport.area'
        db.alter_column('lizard_reportgenerator_generatedreport', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_area.Area'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GeneratedReport.area'
        raise RuntimeError("Cannot reverse this migration. 'GeneratedReport.area' and its values cannot be restored.")
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 25, 11, 16, 58, 1208)'}),
        ...
        'lizard_reportgenerator.generatedreport': {
            ...
            'data_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_security.DataSet']", 'null': 'True', 'blank': 'True'}),
            'generated_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 11, 16, 58, 260874)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
